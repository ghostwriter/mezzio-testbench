# Contributing to Mezzio TestBench
...
```bash
git clone git@github.com:ghostwriter/mezzio-testbench.git
cd mezzio-testbench
git remote add upstream git://github.com/ghostwriter/mezzio-testbench.git
```
